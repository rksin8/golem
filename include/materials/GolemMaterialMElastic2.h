...
class GolemMaterialMElastic2;

template <>
InputParameters validParams<GolemMaterialMElastic2>();

class GolemMaterialMElastic2 : public GolemMaterialBase
{
public:
  GolemMaterialMElastic2(const InputParameters & parameters);
...
protected:
  ...
  Real _c_f;
  Real _c_s;
    Real _alpha_T;  // Linear thermal expansion coefficient TODO:Added by me
  Real _T_source_sink;
